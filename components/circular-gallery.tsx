...
function autoBind(instance: object) {
  ...
  Object.getOwnPropertyNames(proto).forEach(key => {
    const k = key as keyof typeof instance;
    if (key !== 'constructor' && typeof instance[k] === 'function') {
      (instance as Record<string, unknown>)[key] = (instance[k] as () => void).bind(instance);
    }
  });
}
...
class Media {
  ...
  createShader() {
    ...
    const img = new Image();
    // Only use anonymous crossOrigin for external URLs to prevent CORS errors on local images
...
class App {
  ...
  boundOnWheel: (e: WheelEvent) => void = () => undefined;
  boundOnTouchDown: (e: MouseEvent | TouchEvent) => void = () => undefined;
  boundOnTouchMove: (e: MouseEvent | TouchEvent) => void = () => undefined;
  boundOnTouchUp: () => void = () => undefined;
  ...
  createMedias(
    ...
    const defaultItems = [
      { image: `/images/usri.jpg`, text: 'Usri' },
      { image: `/images/yusron.jpg`, text: 'Yusron' },
      { image: `/images/usriyusron.jpg`, text: 'Usri Yusron' },
      { image: `/images/psaa.jpg`, text: 'PSAA' },
      { image: `/images/bukber.jpg`, text: 'Bukber' },
      { image: `/images/rame.jpg`, text: 'Rame' },
    ];
